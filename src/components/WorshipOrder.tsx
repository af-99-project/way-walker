...
export function WorshipOrder({ elementRef }: Props) {
  const [worshipData, setWorshipData] = useState<any[]>([]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="worshipItemWrapper relative">
          ...
          <ul className="space-y-4">
            {worshipData.map((item: any, index: number) => (
              <li
                key={index}
                className="worshipItems relative group pl-[30px]"
                data-aos="fade-up"
              >
