        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative aspect-video bg-black/30 backdrop-blur-md rounded-3xl overflow-hidden border border-white/20">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  <p className="font-semibold text-lg">예배 시간에 실시간으로 송출됩니다</p>
                  <p className="text-sm text-white/80">주일 오전 11:00 / 수요일 오후 7:00</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-4 right-4">
              <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-3 py-1.5 rounded-full">
                ...
                <span className="text-sm font-medium">1,234명 시청 중</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              ...
              <button className="bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors w-full">
                유튜브에서 보기
              </button>
            </div>
